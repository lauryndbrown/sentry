...
describe('AcceptOrganizationInvite', function() {
  it('can accept invitation', async function() {
    ...
    const joinButton = wrapper.find('Button[data-test-id="join-organization"]');
    ...
    expect(
      wrapper.find('Button[data-test-id="join-organization"]').props().disabled
    ).toBe(true);

    await tick();
    expect(browserHistory.push).toHaveBeenCalledWith('/test-org/');
  });
  ...
  it('requires authentication to join', function() {
    ...
    expect(wrapper.find('Button[data-test-id="create-account"]').exists()).toBe(true);
  });
  ...
  it('suggests sso authentication to login', function() {
    ...
    expect(wrapper.find('Button[data-test-id="create-account"]').exists()).toBe(false);

    expect(wrapper.find('[data-test-id="suggests-sso"]').exists()).toBe(true);
    expect(wrapper.find('Button[data-test-id="sso-login"]').exists()).toBe(true);
  });
